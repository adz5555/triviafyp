defmodule Trivia.GamesTest do
  ...
  describe "rooms" do
    ...
    @valid_attrs %{access_code: "some access_code", finished_at: ~D[2010-04-17], max_players: 42}
    @update_attrs %{access_code: "some updated access_code", finished_at: ~D[2011-05-18], max_players: 43}
    @invalid_attrs %{access_code: nil, finished_at: nil, max_players: nil}
