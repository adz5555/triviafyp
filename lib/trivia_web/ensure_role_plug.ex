defmodule TriviaWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.
  ## Example
      plug TriviaWeb.EnsureRolePlug, [:user, :admin]
      plug TriviaWeb.EnsureRolePlug, :admin
      plug TriviaWeb.EnsureRolePlug, ~w(user admin)a
  """
